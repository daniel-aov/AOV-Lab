...
/** Copy all SKILL.md files into tmpDir/.claude/skills/aov-lab/ for auto-discovery */
function installSkills(tmpDir: string) {
  const skillDirs = [
    '', // root aov-lab SKILL.md
  ...
  for (const skill of skillDirs) {
    ...
    const destDir = skill
      ? path.join(tmpDir, '.claude', 'skills', 'aov-lab', skill)
      : path.join(tmpDir, '.claude', 'skills', 'aov-lab');
