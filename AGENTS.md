# aov-lab — AI Engineering Workflow

aov-lab is a collection of SKILL.md files that give AI agents structured roles for
...
| `/aov-lab-upgrade` | Update aov-lab to the latest version. |
