/**
 * aov-lab browse server — persistent Chromium daemon
 *
 * Architecture:
 ...
 *
 * State:
 *   State file: <project-root>/.aov-lab/browse.json (set via BROWSE_STATE_FILE env)
 *   Log files:  <project-root>/.aov-lab/browse-{console,network,dialog}.log
...
function generateHelpText(): string {
  ...
  const lines = ['aov-lab browse — headless browser for AI agents', '', 'Commands:'];
